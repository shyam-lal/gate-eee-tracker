            ...
            content: (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div
                        ...
                        className={`p-6 rounded-[2.5rem] border-2 transition-all cursor-pointer flex flex-col gap-6 relative group ${data.mode === 'flashcard' ? 'border-indigo-500 bg-indigo-500/10' : 'border-slate-800 bg-slate-900/50 hover:border-slate-700'}`}
                    >

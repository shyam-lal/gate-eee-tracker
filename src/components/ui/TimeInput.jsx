            ...
            <div className="flex items-center gap-1.5">
                <div className="relative">
                    <input
                        ...
                        className="w-14 bg-surface-900 border border-surface-800 rounded-lg p-2 pr-1 text-xs text-center text-heading focus:border-primary-500 outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                    />
            ...
            <div className="flex-1 space-y-1.5">
                ...
                <div className="relative">
                    <input
                        ...
                        value={hours}
                        onChange={e => setHours(e.target.value)}
                        className="w-full bg-surface-900 border border-surface-800 rounded-2xl p-4 text-heading text-lg font-mono text-center focus:border-primary-500 outline-none transition-all shadow-inner [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                    />

...
export default function Auth({ onLogin, embedded = false }) {
        ...
        return (
            <div className="w-full py-4 px-2">
                <div className="max-w-md mx-auto">
                    {error && (
                        <div className="bg-rose-500/10 border border-rose-500/50 text-rose-500 p-3 rounded-xl mb-4 text-xs font-bold text-center">
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        {!isLogin && (
                            <div>
                                <input
                                    ...
                                    className="bg-slate-100 w-full outline-none text-slate-800 placeholder-slate-400 text-sm font-medium p-3.5 rounded-2xl border border-transparent focus:border-emerald-500 transition-colors"
                        ...
                        <button disabled={loading || isAnimating} className="w-full bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white py-3.5 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all shadow-md mt-4 text-sm">
                            {loading ? <Loader2 size={18} className="animate-spin" /> : (isLogin ? "Log In & Continue" : 'Sign Up with Email')}
                        </button>
                    </form>

                    <div className="flex items-center gap-4 my-4">
                        <div className="h-px bg-slate-200 flex-1"></div>
                        <span className="text-slate-400 text-[10px] font-bold uppercase tracking-wider">or</span>
                        <div className="h-px bg-slate-200 flex-1"></div>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full bg-white text-slate-700 hover:bg-slate-50 border border-slate-200 disabled:opacity-50 py-3 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all shadow-sm text-sm"
                    >
